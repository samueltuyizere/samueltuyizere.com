          ...
          <div className="lg:flex lg:items-center lg:-mx-10">
            <div className="lg:w-1/2 lg:mx-10">
              ...
              <p className="mt-4 text-gray-500 dark:text-gray-400">
                I am open to opportunities, challenges, questions and more. Feel
                free to reach out.
              </p>
            ...
            <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
              <img
                ...
                src="https://pbs.twimg.com/profile_images/1669384398242709505/HTv6NNNb_400x400.jpg"
                alt=""
              />
              ...
              <div className="mt-6 w-80 md:mt-8">
                ...
                <div className="flex mt-4 -mx-1.5 ">
                  <a
                    ...
                    href="https://twitter.com/samueltuyizere"
                  >
                    <svg
                  ...
                  <a
                    className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500"
                    href="https://linkedin.com/in/samueltuyizere"
                  >
                    <svg
                      className="w-8 h-8"
                      viewBox="0 0 24 24"
                  ...
                  <a
                    className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500"
                    href="https://instagram.com/samueltuyizere"
                  >
                    <svg
                      className="w-8 h-8"
                      viewBox="0 0 24 24"
